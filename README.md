...
- [3. QCoinClub](#3-qcoinclub)
  - [3.1. QCoin](#31-qcoin)
  - [3.2. QCoinClubPortal](#32-qcoinclubportal)
  - [3.3. Access to the portal](#33-access-to-the-portal)
  - [3.4. Unique products & services](#34-unique-products--services)
  - [3.5. Third-party providers](#35-third-party-providers)
  - [3.6. Fees](#36-fees)
- [4. QCoin token economy](#4-qcoin-token-economy)
  - [4.1. Supply](#41-supply)
  - [4.2. Distribution](#42-distribution)
  - [4.3. Governance](#43-governance)
    - [4.3.1. No minting](#431-no-minting)
    - [4.3.2. No mining](#432-no-mining)
    - [4.3.3. No burning](#433-no-burning)
...
- [7. Architecture](#7-architecture)
  ...
  - [7.3. Smart contract](#73-smart-contract)
  - [7.4. Back-office applications](#74-back-office-applications)
# 1. Abstract
...
3. It is also tradeable like any other cryptocurrency, with the potential to appreciate in value and become an investment in itself.
...
Although cryptocurrency payments are not currently being considered, they are not being ruled out.
...
### 4.3.5. QCoin as a governance token
